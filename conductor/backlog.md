...
- [ ] **Multi-Leg Journeys & Dynamic Arrival Times:** Support multi-leg journeys (e.g., Bus to Tube, Train to Bus) with dynamic `expected_arrival_time` calculations instead of static leg durations:
