...
- [x] Capture 45-minute multi-modal corridor time-series snapshots (90 iterations @ 30s) and manifest across all 3 routes and both API paradigms (`tests/fixtures/commute_nelson_to_brick_lane/time_series/`)
